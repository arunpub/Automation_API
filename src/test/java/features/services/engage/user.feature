Feature: Verify Services.Engage.Users
  ...
  @engage @engageuser @createandengageuser
  ...
  @engage @engageuser @changeengageuserpassword
...
#..Verify add roles to engage user....
  @engage @engageuser @addrolestoengageuser
...
#..Verify delete roles of engage user....
  @engage @engageuser @deleterolesfromengageuser
  ...
  @engage @engageuser @isuserwardmember
  Scenario: Verify add roles to engage user
    Given I am getting the participant token for the "Engage" scope
    #Create Account
    When I am able to get the following API endpoint
  ...
  @engage @engageuser @searchuserbyfilter
  Scenario: Verify add roles to engage user
    Given I am getting the participant token for the "Engage" scope
    #Create Account
    When I am able to get the following API endpoint
  ...
  @engage @engageuser @searchengageuserwithteamandrole
...
#  @engage @engageuser @deleteengageuser
